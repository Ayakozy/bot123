...
return`
 𝑯𝒂𝒊 𝑷𝒆𝒓𝒌𝒆𝒏𝒂𝒍𝒌𝒂𝒏 𝑺𝒂𝒚𝒂 𝒂𝒅𝒂𝒍𝒂𝒉 KQNA MD 𝒚𝒂𝒏𝒈 𝒅𝒊 𝑷𝒓𝒐𝒈𝒓𝒂𝒎 𝑫𝒆𝒏𝒈𝒂𝒏 𝒑𝒆𝒎𝒐𝒅𝒆𝒍𝒂𝒏 𝑱𝒂𝒗𝒂𝑺𝒄𝒓𝒊𝒑𝒕 𝒅𝒂𝒏 𝒔𝒂𝒚𝒂 𝒅𝒊𝒌𝒆𝒎𝒃𝒂𝒏𝒈𝒌𝒂𝒏 𝒐𝒍𝒆𝒉 𝒔𝒆𝒔𝒆𝒐𝒓𝒂𝒏𝒈 𝒀𝒂𝒏𝒈 𝑩𝒆𝒓𝒏𝒂𝒎𝒂 𝑭𝒂𝒍𝒍𝑿𝒅.
 
 𝑱𝒊𝒌𝒐𝒖𝒔𝒉𝒐𝒌𝒂𝒊 : 
 "𝑺𝒆𝒑𝒆𝒓𝒕𝒊 𝑺𝒊𝒎𝒇𝒐𝒏𝒊 𝒚𝒂𝒏𝒈 𝒎𝒆𝒏𝒆𝒏𝒂𝒏𝒈𝒌𝒂𝒏 𝑯𝒂𝒕𝒊, 𝑯𝒂𝒍𝒐 𝑨𝒌𝒖 KQNA".
╭랜࿆──────────┈◦•⏤͟͟͞͞★
╎│❦ self *ᴏᴡɴᴇʀ ᴏɴʟʏ*
╎│❦ clearall *ᴏᴡɴᴇʀ ᴏɴʟʏ*
╎│❦ pinchat *ᴏᴡɴᴇʀ ᴏɴʟʏ*
